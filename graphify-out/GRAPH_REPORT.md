...
## Corpus Check
- 101 files · ~47,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 616 nodes · 1026 edges · 59 communities (52 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2e85339`
...
- `delete_download()` --calls--> `get_engine()`  [EXTRACTED]
  api/routes/downloads.py → api/engines/__init__.py
...
Cohesion: 0.12
Nodes (37): apply_node_location(), cluster_helper(), default_server_params(), download_helper(), is_local_host(), is_local_node(), _iso(), _last_openai_check() (+29 more)
...
Cohesion: 0.16
Nodes (22): CacheType, ChatIn, ChatMessage, ClusterIn, ClusterUpdate, DownloadModelIn, EngineType, FitMode (+14 more)
...
Cohesion: 0.11
Nodes (20): _download_fake_run(), FakeResult, _seed(), test_delete_download_removes_row(), test_download_cancel(), test_download_hf_resolves_ollama_quant(), test_download_retry_cancelled(), test_download_retry_failed() (+12 more)
...
Cohesion: 0.18
Nodes (9): Install, Launch params, llama.cpp engine, Process, Related, Node form, Related, Routes (+1 more)
...
Cohesion: 0.10
Nodes (12): _flag_value(), LlamaCppEngine, _node(), test_chat_template_without_jinja_still_emits(), test_defaults_include_owned_flags_and_omit_optional(), test_extra_flags_appended_last(), test_forbidden_extra_flags(), test_jinja_precedes_chat_template_content() (+4 more)
...
Cohesion: 0.08
Nodes (20): ForbiddenExtraFlagsError, _flag_value(), _image(), _is_hub_model(), _model_arg(), _quote_parts(), VllmEngine, test_vllm_cancel_can_keep_partial() (+12 more)
...
### Community 56 - "API"
Cohesion: 0.62
Nodes (5): chatModelOptions(), isModelServed(), modelBasename(), modelsMatch(), pickChatModel()
...
## Knowledge Gaps
- **96 isolated node(s):** `Generated file map`, `Routes`, `Node form`, `Related`, `ChatTurn` (+91 more)
...
- **Why does `VllmEngine` connect `test_status_cache.py` to `test_llama_cpp_argv.py`, `VllmMetalEngine`, `test_openai_proxy.py`, `get_engine`?**
...
- **Why does `ForbiddenExtraFlagsError` connect `test_status_cache.py` to `test_llama_cpp_argv.py`, `nodes.py`, `test_ssh.py`, `get_engine`, `VllmMetalEngine`?**
...
- **What connects `Generated file map`, `Routes`, `Node form` to the rest of the system?**
